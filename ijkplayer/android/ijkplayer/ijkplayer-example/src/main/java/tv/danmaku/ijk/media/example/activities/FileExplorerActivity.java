...
public class FileExplorerActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSettings == null) {
            ...
            mSettings.setLastDirectory("/sdcard/tmp");//("/storage/sdcard0/tmp/");
        }
        ///String ms = android.os.Build.BRAND;
        //String model = android.os.Build.MODEL;
        //String version = android.os.Build.VERSION.RELEASE;
        String lastDirectory = mSettings.getLastDirectory();
        boolean isdir = new File(lastDirectory).isDirectory();
        boolean isemp = TextUtils.isEmpty(lastDirectory);
