...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    {
        mBackEndMediaPlayer.DeliverPacket(mt, encData, pts, framenum);
    }

    @Override
    public void setPlaybackMute(int muted)
    {
        mBackEndMediaPlayer.setPlaybackMute(muted);
    }
    @Override
    public int getPlaybackMute()
    {
        return mBackEndMediaPlayer.getPlaybackMute();
    }
    @Override
    public int GetCurrentImage(String imgPath)
    {
        return mBackEndMediaPlayer.GetCurrentImage(imgPath);
    }

    @Override
    public void StartRecord(String recordPath, String tmpPath)
    {
        mBackEndMediaPlayer.StartRecord(recordPath, tmpPath);
    }

    @Override
    public void StopRecord(int bcancel)
    {
        mBackEndMediaPlayer.StopRecord(bcancel);
    }
    ...
    /*@Override
    public byte[] EchoCancelDeliverDataEx(byte[] micdata, byte[] sddata)
    {
        //return pcmdata;
        return null;
    }*/
    ...
    {
        return -1;//mBackEndMediaPlayer.EncoderOpen(mt, codecId, channel, samplerate, format, bitrate);
    }

    @Override
    public byte[] EncoderDeliverData(long encId, byte[] rawData, long pts)
    {
        return null;//mBackEndMediaPlayer.EncoderDeliverData(encId, rawData, pts);
    }

    @Override
    public void EncoderClose(long encId)
    {
        //mBackEndMediaPlayer.EncoderClose(encId);
    }
}
