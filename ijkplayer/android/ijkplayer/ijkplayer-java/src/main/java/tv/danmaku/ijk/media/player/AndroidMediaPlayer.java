...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    {
        return 0;//mBackEndMediaPlayer.getPlaybackMute();
    }

    @Override
    public void DeliverPacket(int mt, byte[] encData, long pts, long framenum)
    {
        //mInternalMediaPlayer.DeliverPacket(mt, encData, pts, framenum);
    }

    @Override
    public int GetCurrentImage(String imgPath)
    {
        //mInternalMediaPlayer.GetCurrentImage(imgPath);
        return -1;
    }
    ...
    {
        //mInternalMediaPlayer.StartRecord(recordPath);
    }

    @Override
    public void StopRecord(int bcancel)
    {
        //mInternalMediaPlayer.StopRecord();
    }
