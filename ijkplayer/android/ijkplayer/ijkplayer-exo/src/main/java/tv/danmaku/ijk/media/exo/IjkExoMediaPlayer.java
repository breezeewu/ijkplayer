...
public class IjkExoMediaPlayer extends AbstractMediaPlayer {
    ...
    {
        //mInternalPlayer.DeliverPacket(mt, encData, pts, framenum);
    }

    @Override
    public int GetCurrentImage(String imgPath)
    {
        //mInternalPlayer.GetCurrentImage(imgPath);
        return 0;
    }
    ...
    {
        //mInternalPlayer.StartRecord(recordPath);
    }

    @Override
    public void StopRecord(int bcancel)
    {
        //mInternalPlayer.StopRecord();
    }
