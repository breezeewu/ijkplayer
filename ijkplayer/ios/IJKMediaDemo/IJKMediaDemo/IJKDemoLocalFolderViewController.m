...
- (void)viewDidLoad {
    ...
    NSLog(_folderPath);
    [_subpaths addObject:@".."];
    //[_files addObject:@"https://pd-vava-s3-test.s3-us-west-2.amazonaws.com/live/P020101000407010000000496/20190911-180834-0.ts"];
    for (NSString *fileName in files) {
        NSLog(fileName);
        if([fileName containsString:@".mov"] || [fileName containsString:@".mp4"] ||  [fileName containsString:@".data"] ||  [fileName containsString:@".aac"]||  [fileName containsString:@".ts"])
        {
