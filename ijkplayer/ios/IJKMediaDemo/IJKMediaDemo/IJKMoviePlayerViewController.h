...
@interface IJKVideoViewController : UIViewController<IMediaRecordCallback>
@property(atomic,strong) NSURL *url;
//@property(atomic, retain) id<IJKFFMoviePlayerController> player;
...
- (IBAction)onClickEchoCancel:(id)sender;
