...
- (void)deliverData:(int) mt mediadata:(char*) pdata data_size:(int) size present_time:(long long) pts frame_num:(long)frame_num;
...
- (int)readFrame:(char*)pdata frameSize:(int)size mediaType:(int*)mt presentTime:(long long*)pts;
- (void)closeRecord;
// add end
