...
- (void)prepareToPlay;
- (void)deliverData:(int) codec_id mediadata:(char*) pdata data_size:(int) size present_time:(long long) pts_in_ms  frame_num:(long)frame_num;
...
@property(nonatomic, readonly)  long currentVideoTimeStamp;
...
@property (nonatomic) BOOL playbackMuted;
...
/*IJK_EXTERN NSString *const IJKMediaMuxerNotification;
IJK_EXTERN NSString *const IJKMediaMuxerNotificationMsg;
IJK_EXTERN NSString *const IJKMediaMuxerNotificationValue;*/
IJK_EXTERN NSString *const IJKMediaMuxerStartNotification;
IJK_EXTERN NSString *const IJKMediaMuxerProgressNotification;
IJK_EXTERN NSString *const IJKMediaMuxerCompleteNotification;
IJK_EXTERN NSString *const IJKMediaMuxerErrorNotification;
IJK_EXTERN NSString *const IJKMediaMuxerInterruptNotification;

IJK_EXTERN NSString *const IJKMediaMuxerProgressNotificationPTS;
IJK_EXTERN NSString *const IJKMediaMuxerCompleteNotificationDuration;
IJK_EXTERN NSString *const IJKMediaMuxerErrorNotificationReason;
IJK_EXTERN NSString *const IJKMediaMuxerCompleteNotificationInterruptReason;
@end
