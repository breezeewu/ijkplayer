...
/*NSString *const IJKMediaMuxerNotification = @"IJKMediaMuxerNotification";
NSString *const IJKMediaMuxerNotificationMsg = @"IJKMediaMuxerNotificationMsg";
NSString *const IJKMediaMuxerNotificationValue = @"IJKMediaMuxerNotificationValue";*/
NSString *const IJKMediaMuxerStartNotification = @"IJKMediaMuxerStartNotification";
NSString *const IJKMediaMuxerProgressNotification = @"IJKMediaMuxerProgressNotification";
NSString *const IJKMediaMuxerCompleteNotification = @"IJKMediaMuxerCompleteNotification";
NSString *const IJKMediaMuxerErrorNotification = @"IJKMediaMuxerErrorNotification";
NSString *const IJKMediaMuxerProgressNotificationPTS = @"IJKMediaMuxerProgressNotificationPTS";
NSString *const IJKMediaMuxerCompleteNotificationDuration = @"IJKMediaMuxerCompleteNotificationDuration";
...
NSString *const IJKMediaMuxerErrorNotificationReason = @"IJKMediaMuxerErrorNotificationReason";
