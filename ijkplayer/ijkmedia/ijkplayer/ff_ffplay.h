...
#include "ff_ffmsg.h"
#define IJKPLAYER_SUPPORT_HEVC_RAW_DATA
//#define FIX_DELIVER_PACKET_TIMESTAMP
...
// add by zwu for base stream play
...
#else
int ffp_deliver_packet(FFPlayer *ffp, int mediatype, char* pdata, int data_len, int64_t pts);
#endif
