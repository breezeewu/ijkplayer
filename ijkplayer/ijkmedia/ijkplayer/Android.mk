...
LOCAL_SRC_FILES += avenc.c
LOCAL_SRC_FILES += avdemux.c
LOCAL_SRC_FILES += avmuxer.c
LOCAL_SRC_FILES += avrecord.c
LOCAL_SRC_FILES += avresample.c
LOCAL_SRC_FILES += rec_demux.c
LOCAL_SRC_FILES += ipc_record.c
LOCAL_SRC_FILES += audio_proc.c
LOCAL_SRC_FILES += lbsc_media_bitstream.c
LOCAL_SRC_FILES += lbsc_media_parser.c
LOCAL_SRC_FILES += avdev_ctrl.c

LOCAL_SRC_FILES += pipeline/ffpipeline_ffplay.c
LOCAL_SRC_FILES += pipeline/ffpipenode_ffplay_vdec.c

LOCAL_SRC_FILES += android/common_tools_jni.c
LOCAL_SRC_FILES += android/record_api_jni.c
...
LOCAL_STATIC_LIBRARIES := android-ndk-profiler ijksoundtouch audio_processing
