 ...
 * MAX:   ...
 */
#define DEFAULT_FIRST_HIGH_WATER_MARK_IN_MS     (1000)
...
typedef struct VideoState {
    ...
    int seek_buffering;
    AVFrame*    pcur_frame;
    double      dlast_render_vpts;
    double      dlast_render_apts;
    int64_t     llast_render_vtime;
    int64_t     llast_render_atime;
    int64_t     llvframe_count;
    int64_t     llaframe_count;
    int         bdevlier_veof;
    int         bdevlier_aeof;
    int         blive;
    bool        bdrop_audio;
...
typedef struct FFPlayer {
    ...
    // add by dawson for base stream play
    PacketQueue pktq;
    int64_t     llstart_time;
    int64_t     llopen_input_time;
    int64_t     llfind_stream_info_time;
    int64_t     llprepare_time;
    int64_t     lldisplay_time;
    int64_t     llast_vpts;
    int64_t     llast_apts;
    int         blive;
    unsigned long laudio_render_begin;
    unsigned long laudio_render_end;
    int         naudio_render_count;
    FILE*       paudio_pcm_file;
    /*PacketQueue audiodq;
    PacketQueue subtitledq;*/
#ifdef ENABLE_WAITING_FOR_KEYFRAME
    struct avdeliver_control_context* pdev_ctrl;
#endif
} FFPlayer;
