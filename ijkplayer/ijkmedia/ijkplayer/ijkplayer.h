...
// muxer
#define ENABLE_RECORD_DEMUX
// read record test
void*             record_open(char* purl);

int read_frame_header(void* powner, int* pmt, int* psize, int64_t* ppts);
int read_frame(void* powner, int* pmt, char* pdata, int* psize, int64_t* ppts, long* pframe_num);
//int read_frame(void* powner, int* pcodecid, char* pdata, int size, int64_t* ppts);
